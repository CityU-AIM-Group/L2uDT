...
parser.add_argument('-cfg', '--cfg', default='DMFNet', required=True, type=str,
...
parser.add_argument('-restore', '--restore', default='model_best_iter4440_dice84.152.pth', type=str,
